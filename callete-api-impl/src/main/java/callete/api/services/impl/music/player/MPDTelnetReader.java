 ...
 */
public class MPDTelnetReader extends Thread {
  private final static Logger LOG = LoggerFactory.getLogger(MPDTelnetReader.class);

  private TelnetClient tc;
  private String lastCommand;
  private StringBuilder b = new StringBuilder();

  public MPDTelnetReader(TelnetClient tc) {
    this.tc = tc;
  }
