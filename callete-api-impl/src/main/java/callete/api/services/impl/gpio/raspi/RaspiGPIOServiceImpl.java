...
public class RaspiGPIOServiceImpl {
  ...
  private final static String RASPBERRY_PI_3_MODEL_B = "Raspberry Pi 3 Model B";
  ...
  public Object convertPinToApiInstance(int pin) {
    if (board == null) {
      ...
      if (board == null) {
        LOG.warn("No 'gpio.board' configuration found, applying pin of " + RASPBERRY_PI_3_MODEL_B + " as default.");
    ...
    else if (board.equals(RASPBERRY_PI_3_MODEL_B)) {
      return convert2RaspberryPi2ModelBPin(pin);
    }
    return convert2RaspberryPiModelBPin(pin);
  }
